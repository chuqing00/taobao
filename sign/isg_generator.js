        ...
        if (tag === 'canvas') {
            return {
                getContext: function (type) {
                    if (type === 'webgl') {
                        return {
                            getExtension: function () { return { loseContext: function () {} }; }
                        };
                    }
                    return null;
                },
...
// 内嵌核心 IIFE 代码（从 index.js 提取）
const iifeBody = `!function (n, t, r, i, a, o, e, c, u, f, s, l, m, h, v) {
    ...
    !function (n) {
        ...
        function a(n, t, r) {
            if (!(_.indexOf("XueXi") >= 0)) {
                n = (n || "").substr(0, 2e3);
                c({url: n, token: t, cna: o(), ext: r}, "https://fourier.taobao.com/ts?")
            }
        }
    ...
    !function (n) {
        ...
        function r(n) {
            K = n.clientX, Z = n.clientY, F++, nn = o(tn, rn)
        }

        function a(n) {
            Y = n.isTrusted;
            var t = n.touches[0];
            K = t.clientX, Z = t.clientY, F++, nn = o(tn, rn)
        }
        ...
        function e(n) {
            if (N = n.isTrusted, b) {
                var r = n.target, a = r.offsetWidth >> 1, o = r.offsetHeight >> 1;
                if (!(a < 10 && o < 10)) {
                    var e = i.abs(n.offsetX - a), u = i.abs(n.offsetY - o), f = e < 2 && u < 2;
        ...
        function m(n) {
            N = n.isTrusted, tn = n.clientX, rn = n.clientY, Q++
        }

        function v(n) {
            Y = n.isTrusted;
            var t = n.touches[0];
            tn = t.clientX, rn = t.clientY, Q++
        }
        ...
        function A(n) {
            un = n.gamma, cn || (cn = s(function (n) {
                removeEventListener("deviceorientation", A), s(D, 470)
            }, 30))
        }

        function D() {
            cn = 0, addEventListener("deviceorientation", A)
        }
        ...
        function B() {
            ...
            return N = undefined, Y = undefined, {J: n, K: t, L: r}
        }
        ...
        var N, Y, \$, G, U, Q = 0, F = 0, J = 0, V = 0, K = 0, Z = 0, nn = !0, tn = 0, rn = 0, an = !0, on = !1,
            en = !!y.DeviceOrientationEvent;
        (/dingtalk|youku|uczzd\\.cn|sm\\.cn|uc\\.cn/.test(l.hostname) || /Qianniu|DingTalk|Youku/.test(_)) && (en = !1);
        var cn, un = null, fn = [], sn = 0;
        n.D = E, n.F = T, n.G = j, n.H = M, n.I = L, n.M = B, n.N = W, n.O = q, n.P = H, n.Q = O, n.R = S, n.S = X, n.T = C, n.U = I, n.V = P, n.W = R
    }(z || (z = {}));
    var A;
    !function (n) {
        function r() {
        ...
        function d() {
            var n = p.l(), t = p.m(), r = y.innerWidth, i = y.innerHeight;
        ...
        var D = !0, E = 0, T = t(16), j = [r, i, o, e, s], M = [l, m, h, v, g, d];
        n.X = g, n.Y = k;
        var L = f.vendor, B = w.style, W = "chrome" in c, q = "ActiveXObject" in c, H = p.b(y.WeakMap), O = {
            _13: function () {
    ...
    var j, M = function () {
        ...
        return n.prototype.la = function () {
            for (var n = this.ka, t = [], r = -1, i = 0, a = n.length; i < a; i++) for (var o = this[i], e = n[i], c = r += e; t[c] = 255 & o, 0 != --e;) --c, o >>= 8;
            return t
    ...
    !function (n) {
        ...
        function r(n) {
            ...
            a[1] = p.a(), a[5] = A.Z(), a[6] = L.pa(), a[8] = p.c(f.userAgent), a[7] = 0
        }

        function i(n, r) {
            0 == a[4] && (a[4] = p.a(), a[3] = t()), a[2] = t(), a[16] = A.Y();
            var i = !1;
            if (!A.X()) {
                a[9] = z.F(), a[10] = z.G(), a[11] = z.H(), a[12] = z.I();
                var e = z.M();
                a[13] = e.J, a[14] = e.K, i = e.L
            }
            a[17] = z.W(), a[18] = z.U();
            var c = z.P(), u = z.R(), f = z.Q(), s = [r, z.O(), n, c, i, !0, f, u];
            n && o++, a[15] = p.h(s), a[0] = o;
            var l = a.la(), m = j.na(l);
            return m
        }

        var a = new M([2, 2, 4, 4, 4, 1, 1, 4, 4, 3, 2, 2, 2, 2, 2, 1, 2, 1, 1, 1, 1]), o = 0;
        n.D = r, n.qa = i
    }(B || (B = {}));
    var W;
    !function (n) {
        ...
        function v(n) {
            ...
            var i = p.e(n, "?");
            return h(i, y.__sufei_point_list) ? (m(n, 0), !1) : !t(r, D.fa) && (!(r in D.ea) && (!/\\/gw-open\\/|\\/gw\\/|ascp\\.alibaba\\.com/.test(i) && (!h(i, y.__sufei_ignore_list) && (m(n, 0), !1))))
        }
        ...
        function w() {
            ...
            var r = t[0];
            r || (r = p.j(g)), B.D(r), r = B.qa(!1, !1), i(r), 0 === t.length && d(r), p.i(c, "unload", function (n) {
                var t = B.qa(!1, !0);
                z.s(t), p.k(g, t)
            })
        }
    ...
    !function (n) {
        ...
        function i(n) {
            var t = y.Element;
            t ? T.ha(t.prototype, n, a) : (T.ha(w, n, a), T.ha(u.body, n, a))
        }
    ...
    !function (n) {
        ...
        function r() {
            T.ha(y, "fetch", function (n) {
                var t = n[0], r = n[1];
                "string" == typeof t && W.sa(t) && (r = r || {}, r.credentials && "omit" !== r.credentials || (r.credentials = "same-origin"), n[1] = r)
            })
        }
        ...
        function a() {
            var n = y.jsbridge;
            if (n && (n = n["default"])) return T.ha(n, "pushBack", function (n) {
                "native:" === n[0] && W.ra()
            }), !0
        }
...
// 修改 IIFE 末尾注入代码将 B 暴露到 window
const modifiedBody = iifeBody.replace(
    /}\(X\s*\|\|\s*\(X\s*=\s*\{\}\)\)/,
    '}(X || (X = {})); window.__B = B;'
);
...
//是否生成新的 ish token (true=新token, false=复用)
function genIsg(fresh, unload) {
    return B.qa(fresh, unload);
}
function genIsgFresh(){
    return genIsg(true, false);
}


// 导出
module.exports = genIsg;


// const result = genIsgFresh();
// console.log(result);
